...
public class UserFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            String requestedPage = hreq.getPathTranslated();

        //If the attribute loggedInUser in SessionBean1 is null (i.e user has 
            //not logged in) redirect to the login page as long as its not the login page 
            //being requested 
            if (session == null) {
